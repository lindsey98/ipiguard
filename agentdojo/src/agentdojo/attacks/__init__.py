...
import agentdojo.attacks.important_instructions_attacks  # -- needed to register the attacks
import agentdojo.attacks.chat_inject_attacks  # -- needed to register the attacks
import agentdojo.attacks.asb_attacks  # noqa: F401  -- needed to register the attacks
